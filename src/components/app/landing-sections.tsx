...
const TIERS = [
  {
    badge: "Free entry",
    tag: "Public",
    name: "Free Roll Leagues",
    body: "Join public leagues with no entry fee. Compete for bragging rights and leaderboard glory.",
  ...
  },
  {
    ...
    tag: "Monetized",
    name: "Monetized Leagues",
    body: "Join platform-curated leagues with fixed entry fees and published prize pools.",
    prizePool: "Published prize pools",
  ...
  },
  {
    ...
    body: "Create your own private league. Set your own entry fee, invite your circle, and control the rules.",
