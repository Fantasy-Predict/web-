...
export default function HelpClient() {
  ...
  const filteredPopularQuestions = isSearching
  ...
  const hasResults = filteredPopularQuestions.length > 0 || filteredCategories.some((c) => c.topics.length > 0);
          ...
          <div className="mt-8 max-w-2xl mx-auto">
            <div className="relative">
              <Input
                ...
                className="w-full rounded-2xl border-border bg-card/80 px-6 py-4 pr-[5.5rem] text-sm text-foreground placeholder:text-muted-foreground/50 shadow-[var(--shadow-card)] backdrop-blur-sm focus:border-primary focus:ring-primary"
              />
        ...
        <div className="mt-8" data-aos="fade-up" data-aos-delay="100">
          {filteredPopularQuestions.length === 0 ? (
            ...
            <Accordion type="single" collapsible className="w-full">
              {filteredPopularQuestions.map((faq) => (
