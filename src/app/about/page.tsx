...
// 5 stories for the animated "Our Story" section
const STORIES = [
  {
    year: "2024",
    title: "The Idea",
...
export default function AboutPage() {
  return (
    <PublicLayout>
      {/* =============================================================
          HERO — Minimal, no image, brand-focused
          ============================================================= */}
      ...
      {/* =============================================================
          OUR STORY — Animated 5-step timeline
          ============================================================= */}
      ...
      <section className="border-y border-border bg-card/40">
        <div className="mx-auto max-w-6xl px-5 py-20 lg:px-8">
          ...
          {/* Vertical step list instead of grid */}
      ...
      {/* =============================================================
          COMMUNITY — Different image (football pitch / stadium)
          ============================================================= */}
