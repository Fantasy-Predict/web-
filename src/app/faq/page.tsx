          ...
          <div className="mt-8 max-w-2xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-white/5 px-6 py-4 text-sm text-white placeholder:text-white/40 backdrop-blur-sm focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold"
              />
